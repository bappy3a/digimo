...
<?php $__env->startSection('site-title'); ?>
    <?php echo e($course->lang_front->title); ?>
                                                ...
                                                <div id="accordion_<?php echo e($curriculum->id); ?>">
                                                    <div class="card">
                                                        <div class="card-header" >
                                                            <div data-toggle="collapse" data-target="#collapseOne_<?php echo e($curriculum->id); ?>" aria-expanded="<?php echo e($loop->first ? 'true' : 'false'); ?>" aria-controls="collapseOne">
                                                        ...
                                                        <div id="collapseOne_<?php echo e($curriculum->id); ?>" class="collapse <?php if($loop->first): ?> show  <?php endif; ?>"  data-parent="#accordion_<?php echo e($curriculum->id); ?>">
                                                            <div class="card-body">
                                                                   ...
                                                                   <li>
                                                                       <a href="<?php echo e(route('frontend.course.lesson',['course_id' => $course->id,'id' => $lesson->id])); ?>">
                                                                           ...
                                                                           <div class="right">
                                                                               ...
                                                                               <?php if(!empty($lesson->preview) && $lesson->preview === 'yes'): ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/nexelit/@core/resources/views/frontend/pages/courses/single.blade.php ENDPATH**/ ?>